...
class Segment:
    ...
    def get_shots(self):
        ...
        frames_less_than_threshold = self.seperate_frames(summed_hist=y, threshold=10)
    ...
    # value
    def seperate_frames(self, summed_hist, threshold):
    ...
    def detect_boundaries(self, frames_less_than_threshold, sampling_rate):
